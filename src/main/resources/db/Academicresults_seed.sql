...
IF NOT EXISTS (SELECT 1 FROM accounts WHERE username = 'admin') INSERT INTO accounts (username, password_hash, role_id, enabled, created_at, updated_at) VALUES ('admin', '$2a$10$YgNCK/lUYBQldeTOKneM8eDNodw/X6P.UgtXfXQnSuPDPYzbDLdFy', @adminRole, 1, SYSDATETIME(), SYSDATETIME());
